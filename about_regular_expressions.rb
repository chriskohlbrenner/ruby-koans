...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When the asterisk isn't the final char in the pattern (/z*z/)--would return nil
  end
  ...
  # character class matches specific character groups, alternations match OR patterns
