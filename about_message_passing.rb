...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # method which has nothing to do with Object#send. So if you want to work with objects
    # of any class, you need to use __send__ to be on the safe side.
    # (http://stackoverflow.com/a/4658359)
  end
