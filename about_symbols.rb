...
class AboutSymbols < Neo::Koan
  ...
  # Because symbols are same internal object, so comparing strings is better
  ...
  # Because they're immutable, symbols can't be easily changed once dynamically created
end
